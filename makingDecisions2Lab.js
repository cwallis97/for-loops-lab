...
for (var i = 0; i < nums.length; i++) {
  if (nums[i] % 2 === 0) {
    evensArr[evensArr.length] = nums[i];
  }
}

console.log("Even numbers from nums array:", evensArr);
...
if (myFavoriteNumbers.length < 7) {
  ...
  var someNum = myFavoriteNumbers[6]; // Access the 7th element at index 6
  console.log('The 7th element in the array:', someNum);
}
